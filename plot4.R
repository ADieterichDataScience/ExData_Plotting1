...
png(file = "/Users/andrewdieterich/RStudio/datasciencecoursera/ExData_Plotting1/Plot4.png")
...
plot(DATA2$Sub_metering_1, type = "l", xaxt="n",
     col = "gray", xlab = "", ylab = "Energy sub metering", main = "")
axis(1, at = seq(1, leng, by=leng2), labels= c("Thurs", "Fri", "Sat"))
...
# def off to create the file of 4 plots
